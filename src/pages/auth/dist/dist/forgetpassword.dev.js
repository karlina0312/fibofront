...
var forgetpassword_1 = require('./dist/forgetpassword');

var styles_module_scss_1 = require('./styles.module.scss');

var Forgetpassword = function Forgetpassword() {
  var intl = react_intl_1.useIntl();
  var loading = react_redux_1.useSelector(function (state) {
  ...
  return react_1['default'].createElement(antd_1.Card, {
    ...
    labelAlign: 'left',
    layout: 'vertical',
    className: styles_module_scss_1['default'].form,
    onFinish: handleFinish,
    hideRequiredMark: true
  }, react_1['default'].createElement(components_1.FormInput, {
    required: true,
    name: 'email',
    type: 'input',
    className: styles_module_scss_1['default'].input,
    prefix: react_1['default'].createElement(icons_1.UserOutlined, null),
    ...
    className: styles_module_scss_1['default'].buttonContainer
...
exports['default'] = forgetpassword_1['default'];